# -*- coding: utf-8 -*-
"""
Created on Sat Nov 30 11:27:02 2024
...
if (selected == 'Diabetes Prediction'):
    ...
    if st.button('Diabetes Test Result'):
        try:
            ...
            diab_diagnosis = "Error: Please enter valid numeric values."
...
if (selected == 'Heart Disease Prediction'):
    ...
    if st.button('Heart Disease Test Result'):
        try:
            ...
            heart_diagnosis = "Error: Please enter valid numeric values."
...
if selected == "Parkinsons Prediction":
    ...
    if st.button("Parkinson's Test Result"):
        try:
            ...
            parkinsons_diagnosis = "Error: Please enter valid numeric values."
